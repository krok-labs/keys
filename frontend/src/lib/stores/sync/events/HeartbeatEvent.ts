import { EventType, SynchronizationState, type EventHandler } from "$lib/types";
import { SynchronizationStore, type SynchronizationStoreInterface } from "../SynchronizationStore";
